...
const Cart = () => {
  ...
  const createOrder = async (data) => {
    try {
      const res = await axios.post('https://cosmic-pizza-5rra5eo69-daniel-spec16.vercel.app/api/orders', data)
    ...
    <div className={styles.container}>
      ...
      <div className={styles.right}>
        <div className={styles.wrapper}>
          ...
          <PayPalScriptProvider
                options={{
                    "client-id": "ASAs5O4oLK-zsbumuPnS7StSOrbjfnjBRd6p-rIMjbf0Yaw7KJwjbUkht3AKuFq3SAT9rZj_pNDRG95U",
                    components: "buttons",
                    currency: "USD",
